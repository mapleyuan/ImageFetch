...
import com.maple.imagefetchcore.maple.imageselector.util.ImageLoader;
...
public class ImageFolderListAdapter extends BaseAdapter {
    ...
    public View getView(int arg0, View contentView, ViewGroup arg2) {
        ...
        if (contentView == null) {
            contentView = LayoutInflater.from(mContext).inflate(R.layout.cp_imagefolder_list_item, null, false);
        ...
        //异步加载图片LRU
        ImageLoader.getInstance(3, ImageLoader.Type.LIFO).loadImage(folder.mFirstImagePath, viewHolder.mImageView);
