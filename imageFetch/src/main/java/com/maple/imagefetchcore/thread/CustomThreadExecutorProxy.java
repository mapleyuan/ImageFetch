package com.maple.imagefetchcore.thread;
...
import com.maple.imagefetchcore.utils.ReflectUtil;
...
public class CustomThreadExecutorProxy {
	private final static String POOL_NAME = "commerce_thread_pool";
	...
	private final static String ASYNC_THREAD_NAME = "commerce-single-async-thread";
	
	private static CustomThreadExecutorProxy sInstance;
	
	private GoLauncherThreadExecutor mExecutor;
	...
	private CustomThreadExecutorProxy() {
		...
		mExecutor = new GoLauncherThreadExecutor();
	 ...
	 *
	 */
	private class GoLauncherThreadExecutor extends AbstractThreadExecutor {

		private GoLauncherThreadExecutor() {
